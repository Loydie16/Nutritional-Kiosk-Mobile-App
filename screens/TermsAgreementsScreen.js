    ...
    <ScrollView className="flex-1">
      <View className="px-6 pt-6">
        <Text className="text-justify tracking-wide leading-5">
          Welcome to NutriKiosk Mobile App! These terms and conditions outline
          the rules and regulations for the use of our mobile application.
        </Text>

        <Text className="text-justify tracking-wide leading-5">
          By accessing this mobile application, we assume you accept these terms
          and conditions. Do not continue to use NutriKiosk Mobile App if you do
      ...
      <View className="px-6 pt-10">
        ...
        <Text className="text-justify tracking-wide leading-5 mt-4">
          ...
          this from NutriKiosk Mobile App for your own personal use subjected to
      ...
      <View className="px-6 pt-10">
        ...
        <Text className="text-justify tracking-wide leading-5 mt-4">
          • Publishing any NutriKiosk Mobile App material in any other media.
        </Text>
        <Text className="text-justify tracking-wide leading-5 mt-4">
        ...
        <Text className="text-justify tracking-wide leading-5   ">
          • Using NutriKiosk Mobile App in any way that is or may be damaging to
          our company.
        </Text>
        <Text className="text-justify tracking-wide leading-5 mt-4">
          • Using NutriKiosk Mobile App in any way that impacts user access to
          NutriKiosk Mobile App.
        </Text>
        <Text className="text-justify tracking-wide leading-5 mt-4">
          • Using NutriKiosk Mobile App contrary to applicable laws and
          regulations, or in any way may cause harm to the NutriKiosk Mobile
          App, or to any person or business entity.
        </Text>
        <Text className="text-justify tracking-wide leading-5 mt-4">
          • Engaging in any data mining, data harvesting, data extracting, or
          any other similar activity in relation to NutriKiosk Mobile App.
        </Text>
      </View>
      ...
      <View className="px-6 pt-10">
        ...
        <Text className="text-justify tracking-wide leading-5 mt-4">
          ...
          particular link to NutriKiosk Mobile App. You approve to immediately
          remove all links to NutriKiosk Mobile App upon request. We also
          reserve the right to amend these terms and conditions and it's linking
          policy at any time. By continuously linking to NutriKiosk Mobile App,
      ...
      <View className="px-6 pt-10">
        ...
        <Text className="text-justify tracking-wide leading-5 mt-4">
          ...
          laws of the jurisdiction of Philippines, and you submit to the
          non-exclusive jurisdiction of the state and federal courts located in
          Philippines for the resolution of any disputes.
        </Text>
      </View>
