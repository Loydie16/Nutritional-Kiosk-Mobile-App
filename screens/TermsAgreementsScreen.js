    ...
    <ScrollView className="flex-1">
      <View className="px-6 pt-6">
        <Text className="text-justify tracking-wide leading-5">
          Welcome to [Your Mobile Application Name]! These terms and conditions
      ...
      <View className="px-6 pt-2">
        ...
        <Text className="text-justify tracking-wide leading-5 mt-4">
          ...
          may access this from [Your Mobile Application Name] for your own
      ...
      <View className="px-6 pt-6">
        ...
        <Text className="text-justify tracking-wide leading-5 mt-4">
          • Publishing any [Your Mobile Application Name] material in any other
          media.
        </Text>
        <Text className="text-justify tracking-wide leading-5 mt-4">
        ...
        <Text className="text-justify tracking-wide leading-5   ">
          • Using [Your Mobile Application Name] in any way that is or may be
          damaging to [Your Company Name].
        </Text>
        <Text className="text-justify tracking-wide leading-5 mt-4">
          • Using [Your Mobile Application Name] in any way that impacts user
          access to [Your Mobile Application Name].
        </Text>
        <Text className="text-justify tracking-wide leading-5 mt-4">
          • Using [Your Mobile Application Name] contrary to applicable laws and
