    ...
    <>
      ...
      >
        <View className="items-center justify-center bg-white border-2 border-slate-400 rounded-2xl p-6 dark:bg-[#232323] dark:border-2 dark:border-slate-400 ">
          <Text className="text-lg self-center justify-center tracking-wide leading-2 text-justify dark:text-white">
            This recommendation that is generated by artificial
            intelligence with the approval of a licensed nutritionist, serves
            only as a recommendation or guidance. However, it's essential to
            consult with a real nutritionist or doctor for a personalized advice.
          </Text>
        </View>
      </Modal>
    </>
